...
modes = {
    "App":"the prompt will be used to App building AI, design the prompt such that I get most elegent output from that AI",
...
if __name__ == "__main__":
    prompt = "Develop a app that resembles the same functionality as the following python code:{code-pasted-here} Make it look attractive to my user - MOST MOST IMPORTANT INSTRUCTIONS - DON'T CHANGE ATLEAST A LINE IN FUNCTIONALITY - NO NEED TO USE GEMINI API I ALREADY USING GEMINI VIA LANGCHAIN IMPLIMENT THAT ONLY - DON'T USE GENKIT OR IMPLEMENT THE GENKIT"
    mode="App"
    print("\nOptimized Prompt:\n")
    optimized=""
